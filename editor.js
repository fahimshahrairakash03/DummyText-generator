...
form.addEventListener('submit', function(e){
    ...
    if(isNaN(value) || value < 0 || value >9)
    {
        ...
        const slicearr = text.slice(0, value);
        const final = slicearr.map(function(dumy){
            return `<p>${dumy}</p>`;
        }) .join('');
